...
const Header = (props: { children: ReactNode; className?: string }) => {
  return (
    <header
      className={twMerge(
        'z-10 flex flex-col justify-center border-b border-violet-500/10 bg-[#0b1026] px-6 pt-6 pb-3 text-white',
...
const Main = (props: { children: ReactNode; className?: string }) => {
  return (
    <main
      className={twMerge(
        clsx('grow overflow-y-auto bg-[#0b1026] p-6 pt-3 text-white'),
        props.className,
      )}
    >
      {props.children}
